...
class Course(models.Model):
    ...
    courseMaxNum=models.IntegerField(null=True)                            #限制课程人数数量
    courseStartTime=models.CharField(max_length=500,null=True)             #开始时间
    courseOverTime = models.CharField(max_length=500,null=True)            #结束时间
